...
Микросервис оперирует двумя базами данных H2, одна из которых предоставляется другим микросервисом - в ней хранятся количественные метрики прогресса изучения пользователей, а другая создаётся для хранения достижений.
